...
import { C as definePreviewAddon10 } from "./components-BYfudQf0.js";
import { t as DocsRenderer } from "./chunk-OATZR77O-B8wr95ux.js";
...
var excludeTags = Object.entries(globalThis.TAGS_OPTIONS ?? {}).reduce((acc, entry) => {
	...
	renderer: async () => {
		let { DocsRenderer } = await import("./DocsRenderer-LL677BLK-B9yNPe2l.js");
